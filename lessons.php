<?php include './includes/header.php'; ?>
    ...
    <div class="search-bar">
        ...
        <form action="projects.php" method="post">
            <input type="text" name="search-term" value="" placeholder="Enter your search">
        </form>
        </div>
    </div>
                    ...
                    <div class="single-project">
                        ...
                        <div class="project">
                            <div class="project-content">
                                <a href="#">
                                    <h3>Thou Shall not Commit Adultery</h3>
                                   <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Autem eos ipsum quae deserunt, laborum itaque sequi possimus ex a alias nam ea tenetur, enim, id reprehenderit non aspernatur pariatur! Eum laudantium nisi, illum veniam qui tempora alias rem perferendis magnam.</p>
                                </a>
                            </div>
                            <div class="project-details">
                                <small class="author text-muted">Pst. S. Ola Augustus</small>
                                <small class="comments text-muted"><span> 8 </span> Comments </small>
                                <small class="date text-muted">Sunday (23-5-2023)</small>
                            </div>
                        </div>
                    </div>
                    <div class="single-project">
